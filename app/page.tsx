...
export default function Home() {
  return (
    <main className="min-h-screen">
      ...
      {/* 7. 925 Silver Post (FineGold section) */}
      ...
      {/* 12. The Orinket Story */}
      <AnimatedSection animation="fadeIn" delay={550}>
        <BrandStory />
      </AnimatedSection>

      {/* 13. Trusted by Our Community (Reviews) */}
      <AnimatedSection animation="slideInLeft" delay={600}>
        <Reviews />
      </AnimatedSection>

      {/* 14. Buy Everyday Demi-Fine Jewellery CTA */}
      <AnimatedSection animation="scaleIn" delay={650}>
        <CTABanner />
      </AnimatedSection>
