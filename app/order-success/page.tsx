      ...
      <main className="flex-1 flex items-center justify-center py-16">
        <div className="max-w-lg mx-auto px-4 text-center">
          ...
          <div className="bg-cream p-6 rounded-sm mb-8">
            <p className="text-sm text-muted-foreground font-[family-name:var(--font-nunito)] mb-2">
              Order Number
            </p>
            <p className="text-xl font-semibold font-[family-name:var(--font-nunito)] text-foreground">
              {orderNumber}
            </p>
          </div>
          ...
          <div className="space-y-4 mb-8 text-left">
            <div className="flex items-start gap-4 p-4 bg-white border border-border rounded-sm">
              ...
              <div>
                <h3 className="font-semibold font-[family-name:var(--font-nunito)] text-foreground text-sm">
                  Order Confirmation
                </h3>
          ...
          <div className="space-y-4">
            ...
            <Link
              href="/"
              className="w-full py-4 border border-foreground text-foreground font-[family-name:var(--font-nunito)] tracking-wider hover:bg-foreground hover:text-white transition-colors block"
            >
              CONTINUE SHOPPING
            </Link>
          </div>
