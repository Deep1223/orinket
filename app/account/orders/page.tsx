    ...
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-1">
        <div className="max-w-4xl mx-auto px-4 py-8">
          {/* Breadcrumb */}
          <div className="flex items-center gap-2 text-sm font-[family-name:var(--font-montserrat)] text-muted-foreground mb-8">
              ...
              {demoOrders.map((order) => (
                <div key={order.id} className="bg-white border border-border rounded-sm overflow-hidden">
                  ...
                  <div className="flex flex-col md:flex-row md:items-center justify-between gap-4 p-4 bg-cream border-b border-border">
                    <div className="flex flex-wrap items-center gap-4 text-sm font-[family-name:var(--font-montserrat)]">
                      <div>
                    ...
                    <div className={`inline-flex items-center gap-2 px-3 py-1 rounded-full text-xs font-[family-name:var(--font-montserrat)] ${getStatusColor(order.status)}`}>
                    ...
                    {order.items.map((item, index) => (
                      <div key={index} className="flex gap-4">
                        ...
                        <div className="flex-1">
                          <h3 className="font-[family-name:var(--font-montserrat)] text-foreground">
                            {item.name}
                          </h3>
                          <p className="text-sm text-muted-foreground font-[family-name:var(--font-montserrat)] mt-1">
                            Qty: {item.quantity}
                          </p>
                          <p className="text-sm font-semibold font-[family-name:var(--font-montserrat)] mt-1">
                  ...
                  <div className="flex items-center justify-between p-4 border-t border-border">
                    <div className="text-sm font-[family-name:var(--font-montserrat)]">
                      <span className="text-muted-foreground">Total: </span>
                      <span className="font-semibold text-foreground">Rs.{order.total.toLocaleString()}</span>
                    </div>
                    <div className="flex items-center gap-3">
                      {order.status === "shipped" && (
                        <button className="text-sm text-gold-dark font-[family-name:var(--font-montserrat)] hover:underline">
                          Track Order
                        </button>
                      )}
                      <button className="text-sm text-foreground font-[family-name:var(--font-montserrat)] hover:text-gold-dark transition-colors flex items-center gap-1">
                        View Details
                        <ChevronRight className="w-4 h-4" />
                      </button>
                    </div>
