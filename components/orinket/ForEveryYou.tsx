  ...
  return (
    <section className="py-16 md:py-24">
      <div className="max-w-7xl mx-auto px-4">
        <h2 className="text-3xl md:text-4xl font-light tracking-[0.1em] mb-4 text-center font-[family-name:var(--font-cormorant)] animate-fadeIn">
          FOR EVERY YOU
        </h2>
        <p className="text-center text-muted-foreground mb-12 font-[family-name:var(--font-montserrat)] max-w-xl mx-auto animate-slideUp">
          ...
          {occasions.map((occasion, index) => (
            ...
            >
              ...
              <div className="absolute bottom-0 left-0 right-0 p-6 text-white translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
                <h3 className="text-xl md:text-2xl tracking-[0.1em] mb-2 font-[family-name:var(--font-cormorant)]">
                  {occasion.title}
                </h3>
